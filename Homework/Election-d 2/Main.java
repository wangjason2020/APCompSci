public class Main {
    ...
    public static void checkDuplicate(String id) {

        for (int i=0; i<a.length; i++) {
            if (id.equals(a[i].substring(0,6))) {
                duplicate=true;
            } else {
                duplicate=false;
            }
